...
module ConnectWise
  class TaxCodesApi
    ...
    def finance_tax_codes_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/finance/taxCodes/count".sub('{format}','json')
    ...
    def finance_tax_codes_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/finance/taxCodes".sub('{format}','json')
    ...
    def finance_tax_codes_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling TaxCodesApi.finance_tax_codes_id_delete" if id.nil?
      # resource path
      local_var_path = "/finance/taxCodes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_tax_codes_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TaxCodesApi.finance_tax_codes_id_get" if id.nil?
      # resource path
      local_var_path = "/finance/taxCodes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_tax_codes_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TaxCodesApi.finance_tax_codes_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling TaxCodesApi.finance_tax_codes_id_patch" if operations.nil?
      # resource path
      local_var_path = "/finance/taxCodes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_tax_codes_id_put_with_http_info(id, tax_code, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TaxCodesApi.finance_tax_codes_id_put" if id.nil?
      # verify the required parameter 'tax_code' is set
      fail ArgumentError, "Missing the required parameter 'tax_code' when calling TaxCodesApi.finance_tax_codes_id_put" if tax_code.nil?
      # resource path
      local_var_path = "/finance/taxCodes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_tax_codes_post_with_http_info(tax_code, opts = {})
      ...
      # verify the required parameter 'tax_code' is set
      fail ArgumentError, "Missing the required parameter 'tax_code' when calling TaxCodesApi.finance_tax_codes_post" if tax_code.nil?
      # resource path
      local_var_path = "/finance/taxCodes".sub('{format}','json')

...
module Connectwise
  class InvoicePaymentsApi
    ...
    def finance_invoices_id_payments_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_get" if id.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_invoices_id_payments_payment_id_delete_with_http_info(id, payment_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_delete" if id.nil?
      # verify the required parameter 'payment_id' is set
      fail ArgumentError, "Missing the required parameter 'payment_id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_delete" if payment_id.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments/{paymentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'paymentId' + '}', payment_id.to_s)
    ...
    def finance_invoices_id_payments_payment_id_get_with_http_info(id, payment_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_get" if id.nil?
      # verify the required parameter 'payment_id' is set
      fail ArgumentError, "Missing the required parameter 'payment_id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_get" if payment_id.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments/{paymentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'paymentId' + '}', payment_id.to_s)
    ...
    def finance_invoices_id_payments_payment_id_patch_with_http_info(id, payment_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_patch" if id.nil?
      # verify the required parameter 'payment_id' is set
      fail ArgumentError, "Missing the required parameter 'payment_id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_patch" if payment_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_patch" if operations.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments/{paymentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'paymentId' + '}', payment_id.to_s)
    ...
    def finance_invoices_id_payments_payment_id_put_with_http_info(id, payment_id, payment, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_put" if id.nil?
      # verify the required parameter 'payment_id' is set
      fail ArgumentError, "Missing the required parameter 'payment_id' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_put" if payment_id.nil?
      # verify the required parameter 'payment' is set
      fail ArgumentError, "Missing the required parameter 'payment' when calling InvoicePaymentsApi.finance_invoices_id_payments_payment_id_put" if payment.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments/{paymentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'paymentId' + '}', payment_id.to_s)
    ...
    def finance_invoices_id_payments_post_with_http_info(id, payment, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicePaymentsApi.finance_invoices_id_payments_post" if id.nil?
      # verify the required parameter 'payment' is set
      fail ArgumentError, "Missing the required parameter 'payment' when calling InvoicePaymentsApi.finance_invoices_id_payments_post" if payment.nil?
      # resource path
      local_var_path = "/finance/invoices/{id}/payments".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

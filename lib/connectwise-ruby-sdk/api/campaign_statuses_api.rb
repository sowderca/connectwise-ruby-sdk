...
module ConnectWise
  class CampaignStatusesApi
    ...
    def marketing_campaigns_statuses_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/marketing/campaigns/statuses/count".sub('{format}','json')
    ...
    def marketing_campaigns_statuses_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/marketing/campaigns/statuses".sub('{format}','json')
    ...
    def marketing_campaigns_statuses_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_delete" if id.nil?
      # resource path
      local_var_path = "/marketing/campaigns/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_campaigns_statuses_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_get" if id.nil?
      # resource path
      local_var_path = "/marketing/campaigns/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_campaigns_statuses_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_patch" if operations.nil?
      # resource path
      local_var_path = "/marketing/campaigns/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_campaigns_statuses_id_put_with_http_info(id, campaign_status, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_put" if id.nil?
      # verify the required parameter 'campaign_status' is set
      fail ArgumentError, "Missing the required parameter 'campaign_status' when calling CampaignStatusesApi.marketing_campaigns_statuses_id_put" if campaign_status.nil?
      # resource path
      local_var_path = "/marketing/campaigns/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_campaigns_statuses_post_with_http_info(campaign_status, opts = {})
      ...
      # verify the required parameter 'campaign_status' is set
      fail ArgumentError, "Missing the required parameter 'campaign_status' when calling CampaignStatusesApi.marketing_campaigns_statuses_post" if campaign_status.nil?
      # resource path
      local_var_path = "/marketing/campaigns/statuses".sub('{format}','json')

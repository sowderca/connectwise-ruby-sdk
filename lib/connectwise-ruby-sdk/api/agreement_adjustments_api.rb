...
module Connectwise
  class AgreementAdjustmentsApi
    ...
    def finance_agreements_id_adjustments_adjustment_id_delete_with_http_info(id, adjustment_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_delete" if id.nil?
      # verify the required parameter 'adjustment_id' is set
      fail ArgumentError, "Missing the required parameter 'adjustment_id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_delete" if adjustment_id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments/{adjustmentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'adjustmentId' + '}', adjustment_id.to_s)
    ...
    def finance_agreements_id_adjustments_adjustment_id_get_with_http_info(id, adjustment_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_get" if id.nil?
      # verify the required parameter 'adjustment_id' is set
      fail ArgumentError, "Missing the required parameter 'adjustment_id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_get" if adjustment_id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments/{adjustmentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'adjustmentId' + '}', adjustment_id.to_s)
    ...
    def finance_agreements_id_adjustments_adjustment_id_patch_with_http_info(id, adjustment_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_patch" if id.nil?
      # verify the required parameter 'adjustment_id' is set
      fail ArgumentError, "Missing the required parameter 'adjustment_id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_patch" if adjustment_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_patch" if operations.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments/{adjustmentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'adjustmentId' + '}', adjustment_id.to_s)
    ...
    def finance_agreements_id_adjustments_adjustment_id_put_with_http_info(id, adjustment_id, adjustment, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_put" if id.nil?
      # verify the required parameter 'adjustment_id' is set
      fail ArgumentError, "Missing the required parameter 'adjustment_id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_put" if adjustment_id.nil?
      # verify the required parameter 'adjustment' is set
      fail ArgumentError, "Missing the required parameter 'adjustment' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_adjustment_id_put" if adjustment.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments/{adjustmentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'adjustmentId' + '}', adjustment_id.to_s)
    ...
    def finance_agreements_id_adjustments_count_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_count_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_adjustments_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_adjustments_post_with_http_info(id, adjustment, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_post" if id.nil?
      # verify the required parameter 'adjustment' is set
      fail ArgumentError, "Missing the required parameter 'adjustment' when calling AgreementAdjustmentsApi.finance_agreements_id_adjustments_post" if adjustment.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/adjustments".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

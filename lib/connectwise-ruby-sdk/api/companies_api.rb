...
module Connectwise
  class CompaniesApi
    ...
    def company_companies_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies/count".sub('{format}','json')
    ...
    def company_companies_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies".sub('{format}','json')
    ...
    def company_companies_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.company_companies_id_delete" if id.nil?
      # resource path
    ...
    def company_companies_id_merge_post_with_http_info(id, merge, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.company_companies_id_merge_post" if id.nil?
      # verify the required parameter 'merge' is set
      fail ArgumentError, "Missing the required parameter 'merge' when calling CompaniesApi.company_companies_id_merge_post" if merge.nil?
      # resource path
      local_var_path = "/company/companies/{id}/merge".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.company_companies_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CompaniesApi.company_companies_id_patch" if operations.nil?
      # resource path
      local_var_path = "/company/companies/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_put_with_http_info(id, company, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.company_companies_id_put" if id.nil?
      # verify the required parameter 'company' is set
      fail ArgumentError, "Missing the required parameter 'company' when calling CompaniesApi.company_companies_id_put" if company.nil?
      # resource path
      local_var_path = "/company/companies/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_post_with_http_info(company, opts = {})
      ...
      # verify the required parameter 'company' is set
      fail ArgumentError, "Missing the required parameter 'company' when calling CompaniesApi.company_companies_post" if company.nil?
      # resource path
      local_var_path = "/company/companies".sub('{format}','json')

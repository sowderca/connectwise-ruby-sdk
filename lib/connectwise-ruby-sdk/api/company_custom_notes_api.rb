...
module ConnectWise
  class CompanyCustomNotesApi
    ...
    def company_companies_id_custom_status_notes_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_count_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_custom_status_notes_custom_note_id_delete_with_http_info(id, custom_note_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_delete" if id.nil?
      # verify the required parameter 'custom_note_id' is set
      fail ArgumentError, "Missing the required parameter 'custom_note_id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_delete" if custom_note_id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes/{customNoteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'customNoteId' + '}', custom_note_id.to_s)
    ...
    def company_companies_id_custom_status_notes_custom_note_id_get_with_http_info(id, custom_note_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_get" if id.nil?
      # verify the required parameter 'custom_note_id' is set
      fail ArgumentError, "Missing the required parameter 'custom_note_id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_get" if custom_note_id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes/{customNoteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'customNoteId' + '}', custom_note_id.to_s)
    ...
    def company_companies_id_custom_status_notes_custom_note_id_patch_with_http_info(id, custom_note_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_patch" if id.nil?
      # verify the required parameter 'custom_note_id' is set
      fail ArgumentError, "Missing the required parameter 'custom_note_id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_patch" if custom_note_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_patch" if operations.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes/{customNoteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'customNoteId' + '}', custom_note_id.to_s)
    ...
    def company_companies_id_custom_status_notes_custom_note_id_put_with_http_info(id, custom_note_id, custom_note, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_put" if id.nil?
      # verify the required parameter 'custom_note_id' is set
      fail ArgumentError, "Missing the required parameter 'custom_note_id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_put" if custom_note_id.nil?
      # verify the required parameter 'custom_note' is set
      fail ArgumentError, "Missing the required parameter 'custom_note' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_custom_note_id_put" if custom_note.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes/{customNoteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'customNoteId' + '}', custom_note_id.to_s)
    ...
    def company_companies_id_custom_status_notes_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_custom_status_notes_post_with_http_info(id, custom_note, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_post" if id.nil?
      # verify the required parameter 'custom_note' is set
      fail ArgumentError, "Missing the required parameter 'custom_note' when calling CompanyCustomNotesApi.company_companies_id_custom_status_notes_post" if custom_note.nil?
      # resource path
      local_var_path = "/company/companies/{id}/customStatusNotes".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

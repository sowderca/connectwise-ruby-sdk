...
module ConnectWise
  class DocumentsApi
    ...
    def system_documents_count_get_with_http_info(opts = {})
      ...
      if opts[:'record_type'] && !['Agreement', 'Company', 'Configuration', 'Contact', 'Expense', 'Opportunity', 'Project', 'PurchaseOrder', 'Rma', 'SalesOrder', 'Ticket', 'ServiceTemplate', 'KnowledgeBase', 'ToolbarIcon', 'ProductSetup'].include?(opts[:'record_type'])
        fail ArgumentError, 'invalid value for "record_type", must be one of Agreement, Company, Configuration, Contact, Expense, Opportunity, Project, PurchaseOrder, Rma, SalesOrder, Ticket, ServiceTemplate, KnowledgeBase, ToolbarIcon, ProductSetup'
      end
      # resource path
    ...
    def system_documents_id_post_with_http_info(id, record_id, record_type, title, url, opts = {})
      ...
      # verify enum value
      unless ['Ticket', 'Company', 'Configuration', 'Contact', 'Expense', 'Opportunity', 'PurchaseOrder', 'Project', 'SalesOrder', 'ServiceTemplate', 'Rma', 'Agreement', 'ToolbarIcon'].include?(record_type)
        fail ArgumentError, "invalid value for 'record_type', must be one of Ticket, Company, Configuration, Contact, Expense, Opportunity, PurchaseOrder, Project, SalesOrder, ServiceTemplate, Rma, Agreement, ToolbarIcon"
      end

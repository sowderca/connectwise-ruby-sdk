...
module Connectwise
  class OpportunityTypesApi
    ...
    def sales_opportunities_types_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/opportunities/types/count".sub('{format}','json')
    ...
    def sales_opportunities_types_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/opportunities/types".sub('{format}','json')
    ...
    def sales_opportunities_types_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityTypesApi.sales_opportunities_types_id_delete" if id.nil?
      # resource path
      local_var_path = "/sales/opportunities/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_types_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityTypesApi.sales_opportunities_types_id_get" if id.nil?
      # resource path
      local_var_path = "/sales/opportunities/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_types_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityTypesApi.sales_opportunities_types_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling OpportunityTypesApi.sales_opportunities_types_id_patch" if operations.nil?
      # resource path
      local_var_path = "/sales/opportunities/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_types_id_put_with_http_info(id, opportunity_type, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityTypesApi.sales_opportunities_types_id_put" if id.nil?
      # verify the required parameter 'opportunity_type' is set
      fail ArgumentError, "Missing the required parameter 'opportunity_type' when calling OpportunityTypesApi.sales_opportunities_types_id_put" if opportunity_type.nil?
      # resource path
      local_var_path = "/sales/opportunities/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_types_post_with_http_info(opportunity_type, opts = {})
      ...
      # verify the required parameter 'opportunity_type' is set
      fail ArgumentError, "Missing the required parameter 'opportunity_type' when calling OpportunityTypesApi.sales_opportunities_types_post" if opportunity_type.nil?
      # resource path
      local_var_path = "/sales/opportunities/types".sub('{format}','json')

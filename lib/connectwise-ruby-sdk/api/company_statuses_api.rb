...
module Connectwise
  class CompanyStatusesApi
    ...
    def company_companies_statuses_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies/statuses/count".sub('{format}','json')
    ...
    def company_companies_statuses_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies/statuses".sub('{format}','json')
    ...
    def company_companies_statuses_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.company_companies_statuses_id_delete" if id.nil?
      # resource path
      local_var_path = "/company/companies/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_statuses_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.company_companies_statuses_id_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_statuses_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.company_companies_statuses_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CompanyStatusesApi.company_companies_statuses_id_patch" if operations.nil?
      # resource path
      local_var_path = "/company/companies/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_statuses_id_put_with_http_info(id, company_status, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.company_companies_statuses_id_put" if id.nil?
      # verify the required parameter 'company_status' is set
      fail ArgumentError, "Missing the required parameter 'company_status' when calling CompanyStatusesApi.company_companies_statuses_id_put" if company_status.nil?
      # resource path
      local_var_path = "/company/companies/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_statuses_post_with_http_info(company_status, opts = {})
      ...
      # verify the required parameter 'company_status' is set
      fail ArgumentError, "Missing the required parameter 'company_status' when calling CompanyStatusesApi.company_companies_statuses_post" if company_status.nil?
      # resource path
      local_var_path = "/company/companies/statuses".sub('{format}','json')

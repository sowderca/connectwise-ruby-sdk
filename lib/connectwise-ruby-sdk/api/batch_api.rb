...
module ConnectWise
  class BatchApi
    ...
    def system_batch_post_with_http_info(request, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'request' when calling BatchApi.system_batch_post" if request.nil?
      # resource path
      local_var_path = "/system/batch".sub('{format}','json')

...
module Connectwise
  class ProjectPhasesApi
    ...
    def project_projects_id_phases_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_count_get" if id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_id_phases_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_get" if id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_id_phases_phase_id_delete_with_http_info(id, phase_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_delete" if id.nil?
      # verify the required parameter 'phase_id' is set
      fail ArgumentError, "Missing the required parameter 'phase_id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_delete" if phase_id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases/{phaseId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'phaseId' + '}', phase_id.to_s)
    ...
    def project_projects_id_phases_phase_id_get_with_http_info(id, phase_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_get" if id.nil?
      # verify the required parameter 'phase_id' is set
      fail ArgumentError, "Missing the required parameter 'phase_id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_get" if phase_id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases/{phaseId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'phaseId' + '}', phase_id.to_s)
    ...
    def project_projects_id_phases_phase_id_patch_with_http_info(id, phase_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_patch" if id.nil?
      # verify the required parameter 'phase_id' is set
      fail ArgumentError, "Missing the required parameter 'phase_id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_patch" if phase_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_patch" if operations.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases/{phaseId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'phaseId' + '}', phase_id.to_s)
    ...
    def project_projects_id_phases_phase_id_put_with_http_info(id, phase_id, project_phase, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_put" if id.nil?
      # verify the required parameter 'phase_id' is set
      fail ArgumentError, "Missing the required parameter 'phase_id' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_put" if phase_id.nil?
      # verify the required parameter 'project_phase' is set
      fail ArgumentError, "Missing the required parameter 'project_phase' when calling ProjectPhasesApi.project_projects_id_phases_phase_id_put" if project_phase.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases/{phaseId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'phaseId' + '}', phase_id.to_s)
    ...
    def project_projects_id_phases_post_with_http_info(id, project_phase, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectPhasesApi.project_projects_id_phases_post" if id.nil?
      # verify the required parameter 'project_phase' is set
      fail ArgumentError, "Missing the required parameter 'project_phase' when calling ProjectPhasesApi.project_projects_id_phases_post" if project_phase.nil?
      # resource path
      local_var_path = "/project/projects/{id}/phases".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

...
module ConnectWise
  class CompanySitesApi
    ...
    def company_companies_id_sites_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_count_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_sites_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_sites_post_with_http_info(id, site, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_post" if id.nil?
      # verify the required parameter 'site' is set
      fail ArgumentError, "Missing the required parameter 'site' when calling CompanySitesApi.company_companies_id_sites_post" if site.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_id_sites_site_id_delete_with_http_info(id, site_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_site_id_delete" if id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling CompanySitesApi.company_companies_id_sites_site_id_delete" if site_id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites/{siteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def company_companies_id_sites_site_id_get_with_http_info(id, site_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_site_id_get" if id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling CompanySitesApi.company_companies_id_sites_site_id_get" if site_id.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites/{siteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def company_companies_id_sites_site_id_patch_with_http_info(id, site_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_site_id_patch" if id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling CompanySitesApi.company_companies_id_sites_site_id_patch" if site_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CompanySitesApi.company_companies_id_sites_site_id_patch" if operations.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites/{siteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def company_companies_id_sites_site_id_put_with_http_info(id, site_id, site, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanySitesApi.company_companies_id_sites_site_id_put" if id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling CompanySitesApi.company_companies_id_sites_site_id_put" if site_id.nil?
      # verify the required parameter 'site' is set
      fail ArgumentError, "Missing the required parameter 'site' when calling CompanySitesApi.company_companies_id_sites_site_id_put" if site.nil?
      # resource path
      local_var_path = "/company/companies/{id}/sites/{siteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)

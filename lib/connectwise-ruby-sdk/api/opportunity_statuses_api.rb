...
module Connectwise
  class OpportunityStatusesApi
    ...
    def sales_opportunities_statuses_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/opportunities/statuses/count".sub('{format}','json')
    ...
    def sales_opportunities_statuses_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/opportunities/statuses".sub('{format}','json')
    ...
    def sales_opportunities_statuses_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_delete" if id.nil?
      # resource path
      local_var_path = "/sales/opportunities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_statuses_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_get" if id.nil?
      # resource path
      local_var_path = "/sales/opportunities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_statuses_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_patch" if operations.nil?
      # resource path
      local_var_path = "/sales/opportunities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_statuses_id_put_with_http_info(id, status, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_put" if id.nil?
      # verify the required parameter 'status' is set
      fail ArgumentError, "Missing the required parameter 'status' when calling OpportunityStatusesApi.sales_opportunities_statuses_id_put" if status.nil?
      # resource path
      local_var_path = "/sales/opportunities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_opportunities_statuses_post_with_http_info(status, opts = {})
      ...
      # verify the required parameter 'status' is set
      fail ArgumentError, "Missing the required parameter 'status' when calling OpportunityStatusesApi.sales_opportunities_statuses_post" if status.nil?
      # resource path
      local_var_path = "/sales/opportunities/statuses".sub('{format}','json')

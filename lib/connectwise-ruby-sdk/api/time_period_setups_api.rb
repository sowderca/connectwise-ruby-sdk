...
module ConnectWise
  class TimePeriodSetupsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [TimePeriodSetupDefaults]
    ...
    # Get Time Period Setups Default
    # @param [Hash] opts the optional parameters
    # @return [Array<(TimePeriodSetupDefaults, Fixnum, Hash)>] TimePeriodSetupDefaults data, response status code and response headers
    ...
    # @option opts [Integer] :page 
    # @option opts [Integer] :page_size 
    # @return [Array<(Array<TimePeriodSetup>, Fixnum, Hash)>] Array<TimePeriodSetup> data, response status code and response headers
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TimePeriodSetup, Fixnum, Hash)>] TimePeriodSetup data, response status code and response headers

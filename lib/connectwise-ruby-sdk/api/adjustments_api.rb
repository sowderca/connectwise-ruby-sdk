...
module ConnectWise
  class AdjustmentsApi
    ...
    def procurement_adjustments_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/adjustments/count".sub('{format}','json')
    ...
    def procurement_adjustments_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/adjustments".sub('{format}','json')
    ...
    def procurement_adjustments_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentsApi.procurement_adjustments_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentsApi.procurement_adjustments_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentsApi.procurement_adjustments_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling AdjustmentsApi.procurement_adjustments_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_id_put_with_http_info(id, adjustment, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentsApi.procurement_adjustments_id_put" if id.nil?
      # verify the required parameter 'adjustment' is set
      fail ArgumentError, "Missing the required parameter 'adjustment' when calling AdjustmentsApi.procurement_adjustments_id_put" if adjustment.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_post_with_http_info(adjustment, opts = {})
      ...
      # verify the required parameter 'adjustment' is set
      fail ArgumentError, "Missing the required parameter 'adjustment' when calling AdjustmentsApi.procurement_adjustments_post" if adjustment.nil?
      # resource path
      local_var_path = "/procurement/adjustments".sub('{format}','json')

...
module Connectwise
  class ProductComponentsApi
    ...
    def procurement_products_id_components_component_id_delete_with_http_info(id, component_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_component_id_delete" if id.nil?
      # verify the required parameter 'component_id' is set
      fail ArgumentError, "Missing the required parameter 'component_id' when calling ProductComponentsApi.procurement_products_id_components_component_id_delete" if component_id.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components/{componentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'componentId' + '}', component_id.to_s)
    ...
    def procurement_products_id_components_component_id_get_with_http_info(id, component_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_component_id_get" if id.nil?
      # verify the required parameter 'component_id' is set
      fail ArgumentError, "Missing the required parameter 'component_id' when calling ProductComponentsApi.procurement_products_id_components_component_id_get" if component_id.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components/{componentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'componentId' + '}', component_id.to_s)
    ...
    def procurement_products_id_components_component_id_patch_with_http_info(id, component_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_component_id_patch" if id.nil?
      # verify the required parameter 'component_id' is set
      fail ArgumentError, "Missing the required parameter 'component_id' when calling ProductComponentsApi.procurement_products_id_components_component_id_patch" if component_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ProductComponentsApi.procurement_products_id_components_component_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components/{componentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'componentId' + '}', component_id.to_s)
    ...
    def procurement_products_id_components_component_id_put_with_http_info(id, component_id, product_component, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_component_id_put" if id.nil?
      # verify the required parameter 'component_id' is set
      fail ArgumentError, "Missing the required parameter 'component_id' when calling ProductComponentsApi.procurement_products_id_components_component_id_put" if component_id.nil?
      # verify the required parameter 'product_component' is set
      fail ArgumentError, "Missing the required parameter 'product_component' when calling ProductComponentsApi.procurement_products_id_components_component_id_put" if product_component.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components/{componentId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'componentId' + '}', component_id.to_s)
    ...
    def procurement_products_id_components_count_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_count_get" if id.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_products_id_components_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_get" if id.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_products_id_components_post_with_http_info(id, product_component, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductComponentsApi.procurement_products_id_components_post" if id.nil?
      # verify the required parameter 'product_component' is set
      fail ArgumentError, "Missing the required parameter 'product_component' when calling ProductComponentsApi.procurement_products_id_components_post" if product_component.nil?
      # resource path
      local_var_path = "/procurement/products/{id}/components".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

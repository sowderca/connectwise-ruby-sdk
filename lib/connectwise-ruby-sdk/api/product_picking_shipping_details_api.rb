  ...
  class ProductPickingShippingDetailsApi
    ...
    def procurement_products_id_picking_shipping_details_count_get_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_count_get"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails/count".sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_get"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails".sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_picking_shipping_detail_id_delete_with_http_info(id, picking_shipping_detail_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_delete"
      end
      # verify the required parameter 'picking_shipping_detail_id' is set
      if @api_client.config.client_side_validation && picking_shipping_detail_id.nil?
        fail ArgumentError, "Missing the required parameter 'picking_shipping_detail_id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_delete"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails/{pickingShippingDetailId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'pickingShippingDetailId' + '}', picking_shipping_detail_id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_picking_shipping_detail_id_get_with_http_info(id, picking_shipping_detail_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_get"
      end
      # verify the required parameter 'picking_shipping_detail_id' is set
      if @api_client.config.client_side_validation && picking_shipping_detail_id.nil?
        fail ArgumentError, "Missing the required parameter 'picking_shipping_detail_id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_get"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails/{pickingShippingDetailId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'pickingShippingDetailId' + '}', picking_shipping_detail_id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_picking_shipping_detail_id_patch_with_http_info(id, picking_shipping_detail_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_patch"
      end
      # verify the required parameter 'picking_shipping_detail_id' is set
      if @api_client.config.client_side_validation && picking_shipping_detail_id.nil?
        fail ArgumentError, "Missing the required parameter 'picking_shipping_detail_id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_patch"
      end
      # verify the required parameter 'operations' is set
      if @api_client.config.client_side_validation && operations.nil?
        fail ArgumentError, "Missing the required parameter 'operations' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_patch"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails/{pickingShippingDetailId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'pickingShippingDetailId' + '}', picking_shipping_detail_id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_picking_shipping_detail_id_put_with_http_info(id, picking_shipping_detail_id, product_picking_shipping_details, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_put"
      end
      # verify the required parameter 'picking_shipping_detail_id' is set
      if @api_client.config.client_side_validation && picking_shipping_detail_id.nil?
        fail ArgumentError, "Missing the required parameter 'picking_shipping_detail_id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_put"
      end
      # verify the required parameter 'product_picking_shipping_details' is set
      if @api_client.config.client_side_validation && product_picking_shipping_details.nil?
        fail ArgumentError, "Missing the required parameter 'product_picking_shipping_details' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_picking_shipping_detail_id_put"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails/{pickingShippingDetailId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'pickingShippingDetailId' + '}', picking_shipping_detail_id.to_s)
    ...
    def procurement_products_id_picking_shipping_details_post_with_http_info(id, product_picking_shipping_details, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_post"
      end
      # verify the required parameter 'product_picking_shipping_details' is set
      if @api_client.config.client_side_validation && product_picking_shipping_details.nil?
        fail ArgumentError, "Missing the required parameter 'product_picking_shipping_details' when calling ProductPickingShippingDetailsApi.procurement_products_id_picking_shipping_details_post"
      end
      # resource path
      local_var_path = "/procurement/products/{id}/pickingShippingDetails".sub('{' + 'id' + '}', id.to_s)

  ...
  class ProjectsApi
    ...
    def project_projects_id_delete_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectsApi.project_projects_id_delete"
      end
      # resource path
    ...
    def project_projects_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectsApi.project_projects_id_patch"
      end
      # verify the required parameter 'operations' is set
      if @api_client.config.client_side_validation && operations.nil?
        fail ArgumentError, "Missing the required parameter 'operations' when calling ProjectsApi.project_projects_id_patch"
      end
      # resource path
      local_var_path = "/project/projects/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_id_put_with_http_info(id, project, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectsApi.project_projects_id_put"
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling ProjectsApi.project_projects_id_put"
      end
      # resource path
      local_var_path = "/project/projects/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_post_with_http_info(project, opts = {})
      ...
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling ProjectsApi.project_projects_post"
      end
      # resource path
      local_var_path = "/project/projects"

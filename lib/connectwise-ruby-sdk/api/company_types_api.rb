...
module Connectwise
  class CompanyTypesApi
    ...
    def company_companies_types_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies/types/count".sub('{format}','json')
    ...
    def company_companies_types_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/companies/types".sub('{format}','json')
    ...
    def company_companies_types_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyTypesApi.company_companies_types_id_delete" if id.nil?
      # resource path
      local_var_path = "/company/companies/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_types_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyTypesApi.company_companies_types_id_get" if id.nil?
      # resource path
      local_var_path = "/company/companies/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_types_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyTypesApi.company_companies_types_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CompanyTypesApi.company_companies_types_id_patch" if operations.nil?
      # resource path
      local_var_path = "/company/companies/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_types_id_put_with_http_info(id, company_type, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CompanyTypesApi.company_companies_types_id_put" if id.nil?
      # verify the required parameter 'company_type' is set
      fail ArgumentError, "Missing the required parameter 'company_type' when calling CompanyTypesApi.company_companies_types_id_put" if company_type.nil?
      # resource path
      local_var_path = "/company/companies/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_companies_types_post_with_http_info(company_type, opts = {})
      ...
      # verify the required parameter 'company_type' is set
      fail ArgumentError, "Missing the required parameter 'company_type' when calling CompanyTypesApi.company_companies_types_post" if company_type.nil?
      # resource path
      local_var_path = "/company/companies/types".sub('{format}','json')

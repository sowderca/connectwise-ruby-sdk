...
module ConnectWise
  class ActivityStatusesApi
    ...
    def sales_activities_statuses_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/activities/statuses/count".sub('{format}','json')
    ...
    def sales_activities_statuses_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/sales/activities/statuses".sub('{format}','json')
    ...
    def sales_activities_statuses_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivityStatusesApi.sales_activities_statuses_id_delete" if id.nil?
      # resource path
      local_var_path = "/sales/activities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_activities_statuses_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivityStatusesApi.sales_activities_statuses_id_get" if id.nil?
      # resource path
      local_var_path = "/sales/activities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_activities_statuses_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivityStatusesApi.sales_activities_statuses_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ActivityStatusesApi.sales_activities_statuses_id_patch" if operations.nil?
      # resource path
      local_var_path = "/sales/activities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_activities_statuses_id_put_with_http_info(id, activity_status, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivityStatusesApi.sales_activities_statuses_id_put" if id.nil?
      # verify the required parameter 'activity_status' is set
      fail ArgumentError, "Missing the required parameter 'activity_status' when calling ActivityStatusesApi.sales_activities_statuses_id_put" if activity_status.nil?
      # resource path
      local_var_path = "/sales/activities/statuses/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def sales_activities_statuses_post_with_http_info(activity_status, opts = {})
      ...
      # verify the required parameter 'activity_status' is set
      fail ArgumentError, "Missing the required parameter 'activity_status' when calling ActivityStatusesApi.sales_activities_statuses_post" if activity_status.nil?
      # resource path
      local_var_path = "/sales/activities/statuses".sub('{format}','json')

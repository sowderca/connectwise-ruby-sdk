...
module ConnectWise
  class AdjustmentDetailsApi
    ...
    def procurement_adjustments_id_details_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_count_get" if id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}/details/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_id_details_detail_id_delete_with_http_info(id, detail_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_detail_id_delete" if id.nil?
      # verify the required parameter 'detail_id' is set
      fail ArgumentError, "Missing the required parameter 'detail_id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_detail_id_delete" if detail_id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}/details/{detailId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'detailId' + '}', detail_id.to_s)
    ...
    def procurement_adjustments_id_details_detail_id_get_with_http_info(id, detail_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_detail_id_get" if id.nil?
      # verify the required parameter 'detail_id' is set
      fail ArgumentError, "Missing the required parameter 'detail_id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_detail_id_get" if detail_id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}/details/{detailId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'detailId' + '}', detail_id.to_s)
    ...
    def procurement_adjustments_id_details_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_get" if id.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}/details".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_adjustments_id_details_post_with_http_info(id, adjustment_detail, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_post" if id.nil?
      # verify the required parameter 'adjustment_detail' is set
      fail ArgumentError, "Missing the required parameter 'adjustment_detail' when calling AdjustmentDetailsApi.procurement_adjustments_id_details_post" if adjustment_detail.nil?
      # resource path
      local_var_path = "/procurement/adjustments/{id}/details".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

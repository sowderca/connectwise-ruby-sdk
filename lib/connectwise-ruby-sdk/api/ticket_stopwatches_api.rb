...
module ConnectWise
  class TicketStopwatchesApi
    ...
    def time_ticketstopwatches_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/time/ticketstopwatches/count".sub('{format}','json')
    ...
    def time_ticketstopwatches_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/time/ticketstopwatches".sub('{format}','json')
    ...
    def time_ticketstopwatches_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.time_ticketstopwatches_id_delete" if id.nil?
      # resource path
      local_var_path = "/time/ticketstopwatches/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_ticketstopwatches_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.time_ticketstopwatches_id_get" if id.nil?
      # resource path
      local_var_path = "/time/ticketstopwatches/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_ticketstopwatches_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.time_ticketstopwatches_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling TicketStopwatchesApi.time_ticketstopwatches_id_patch" if operations.nil?
      # resource path
      local_var_path = "/time/ticketstopwatches/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_ticketstopwatches_id_put_with_http_info(id, ticket_stopwatch, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.time_ticketstopwatches_id_put" if id.nil?
      # verify the required parameter 'ticket_stopwatch' is set
      fail ArgumentError, "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.time_ticketstopwatches_id_put" if ticket_stopwatch.nil?
      # resource path
      local_var_path = "/time/ticketstopwatches/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_ticketstopwatches_post_with_http_info(ticket_stopwatch, opts = {})
      ...
      # verify the required parameter 'ticket_stopwatch' is set
      fail ArgumentError, "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.time_ticketstopwatches_post" if ticket_stopwatch.nil?
      # resource path
      local_var_path = "/time/ticketstopwatches".sub('{format}','json')

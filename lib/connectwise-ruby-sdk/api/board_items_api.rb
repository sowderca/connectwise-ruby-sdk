...
module Connectwise
  class BoardItemsApi
    ...
    def service_boards_id_items_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_count_get" if id.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def service_boards_id_items_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_get" if id.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def service_boards_id_items_item_id_delete_with_http_info(id, item_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_item_id_delete" if id.nil?
      # verify the required parameter 'item_id' is set
      fail ArgumentError, "Missing the required parameter 'item_id' when calling BoardItemsApi.service_boards_id_items_item_id_delete" if item_id.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items/{itemId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'itemId' + '}', item_id.to_s)
    ...
    def service_boards_id_items_item_id_get_with_http_info(id, item_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_item_id_get" if id.nil?
      # verify the required parameter 'item_id' is set
      fail ArgumentError, "Missing the required parameter 'item_id' when calling BoardItemsApi.service_boards_id_items_item_id_get" if item_id.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items/{itemId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'itemId' + '}', item_id.to_s)
    ...
    def service_boards_id_items_item_id_patch_with_http_info(id, item_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_item_id_patch" if id.nil?
      # verify the required parameter 'item_id' is set
      fail ArgumentError, "Missing the required parameter 'item_id' when calling BoardItemsApi.service_boards_id_items_item_id_patch" if item_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling BoardItemsApi.service_boards_id_items_item_id_patch" if operations.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items/{itemId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'itemId' + '}', item_id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Item]
    def service_boards_id_items_item_id_put(id, item_id, item, opts = {})
      data, _status_code, _headers = service_boards_id_items_item_id_put_with_http_info(id, item_id, item, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Item, Fixnum, Hash)>] Item data, response status code and response headers
    def service_boards_id_items_item_id_put_with_http_info(id, item_id, item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BoardItemsApi.service_boards_id_items_item_id_put ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_item_id_put" if id.nil?
      # verify the required parameter 'item_id' is set
      fail ArgumentError, "Missing the required parameter 'item_id' when calling BoardItemsApi.service_boards_id_items_item_id_put" if item_id.nil?
      # verify the required parameter 'item' is set
      fail ArgumentError, "Missing the required parameter 'item' when calling BoardItemsApi.service_boards_id_items_item_id_put" if item.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items/{itemId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'itemId' + '}', item_id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Item]
    def service_boards_id_items_post(id, item, opts = {})
      data, _status_code, _headers = service_boards_id_items_post_with_http_info(id, item, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Item, Fixnum, Hash)>] Item data, response status code and response headers
    def service_boards_id_items_post_with_http_info(id, item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BoardItemsApi.service_boards_id_items_post ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BoardItemsApi.service_boards_id_items_post" if id.nil?
      # verify the required parameter 'item' is set
      fail ArgumentError, "Missing the required parameter 'item' when calling BoardItemsApi.service_boards_id_items_post" if item.nil?
      # resource path
      local_var_path = "/service/boards/{id}/items".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

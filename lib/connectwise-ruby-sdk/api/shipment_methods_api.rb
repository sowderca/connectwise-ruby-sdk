...
module Connectwise
  class ShipmentMethodsApi
    ...
    def procurement_shipmentmethods_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/shipmentmethods/count".sub('{format}','json')
    ...
    def procurement_shipmentmethods_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/shipmentmethods".sub('{format}','json')
    ...
    def procurement_shipmentmethods_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/shipmentmethods/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_shipmentmethods_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/shipmentmethods/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_shipmentmethods_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/shipmentmethods/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_shipmentmethods_id_put_with_http_info(id, shipment_method, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_put" if id.nil?
      # verify the required parameter 'shipment_method' is set
      fail ArgumentError, "Missing the required parameter 'shipment_method' when calling ShipmentMethodsApi.procurement_shipmentmethods_id_put" if shipment_method.nil?
      # resource path
      local_var_path = "/procurement/shipmentmethods/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_shipmentmethods_post_with_http_info(shipment_method, opts = {})
      ...
      # verify the required parameter 'shipment_method' is set
      fail ArgumentError, "Missing the required parameter 'shipment_method' when calling ShipmentMethodsApi.procurement_shipmentmethods_post" if shipment_method.nil?
      # resource path
      local_var_path = "/procurement/shipmentmethods".sub('{format}','json')

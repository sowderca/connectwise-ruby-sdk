  ...
  class ContactCommunicationsApi
    ...
    def company_contacts_id_communications_communication_id_delete_with_http_info(id, communication_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_delete"
      end
      # verify the required parameter 'communication_id' is set
      if @api_client.config.client_side_validation && communication_id.nil?
        fail ArgumentError, "Missing the required parameter 'communication_id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_delete"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications/{communicationId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'communicationId' + '}', communication_id.to_s)
    ...
    def company_contacts_id_communications_communication_id_get_with_http_info(id, communication_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_get"
      end
      # verify the required parameter 'communication_id' is set
      if @api_client.config.client_side_validation && communication_id.nil?
        fail ArgumentError, "Missing the required parameter 'communication_id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_get"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications/{communicationId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'communicationId' + '}', communication_id.to_s)
    ...
    def company_contacts_id_communications_communication_id_patch_with_http_info(id, communication_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_patch"
      end
      # verify the required parameter 'communication_id' is set
      if @api_client.config.client_side_validation && communication_id.nil?
        fail ArgumentError, "Missing the required parameter 'communication_id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_patch"
      end
      # verify the required parameter 'operations' is set
      if @api_client.config.client_side_validation && operations.nil?
        fail ArgumentError, "Missing the required parameter 'operations' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_patch"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications/{communicationId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'communicationId' + '}', communication_id.to_s)
    ...
    def company_contacts_id_communications_communication_id_put_with_http_info(id, communication_id, contact_communication, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_put"
      end
      # verify the required parameter 'communication_id' is set
      if @api_client.config.client_side_validation && communication_id.nil?
        fail ArgumentError, "Missing the required parameter 'communication_id' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_put"
      end
      ...
      if @api_client.config.client_side_validation && contact_communication.nil?
        fail ArgumentError, "Missing the required parameter 'contact_communication' when calling ContactCommunicationsApi.company_contacts_id_communications_communication_id_put"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications/{communicationId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'communicationId' + '}', communication_id.to_s)
    ...
    def company_contacts_id_communications_count_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_count_get"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications/count".sub('{' + 'id' + '}', id.to_s)
    ...
    def company_contacts_id_communications_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_get"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications".sub('{' + 'id' + '}', id.to_s)
    ...
    def company_contacts_id_communications_post_with_http_info(id, contact_communication, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactCommunicationsApi.company_contacts_id_communications_post"
      end
      # verify the required parameter 'contact_communication' is set
      if @api_client.config.client_side_validation && contact_communication.nil?
        fail ArgumentError, "Missing the required parameter 'contact_communication' when calling ContactCommunicationsApi.company_contacts_id_communications_post"
      end
      # resource path
      local_var_path = "/company/contacts/{id}/communications".sub('{' + 'id' + '}', id.to_s)

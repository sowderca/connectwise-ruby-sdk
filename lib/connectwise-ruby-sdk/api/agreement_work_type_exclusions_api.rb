...
module ConnectWise
  class AgreementWorkTypeExclusionsApi
    ...
    def finance_agreements_id_work_type_exclusions_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_count_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workTypeExclusions/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_work_type_exclusions_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workTypeExclusions".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_work_type_exclusions_post_with_http_info(id, work_type_exclusion, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_post" if id.nil?
      # verify the required parameter 'work_type_exclusion' is set
      fail ArgumentError, "Missing the required parameter 'work_type_exclusion' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_post" if work_type_exclusion.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workTypeExclusions".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_work_type_exclusions_work_type_exclusion_id_delete_with_http_info(id, work_type_exclusion_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_work_type_exclusion_id_delete" if id.nil?
      # verify the required parameter 'work_type_exclusion_id' is set
      fail ArgumentError, "Missing the required parameter 'work_type_exclusion_id' when calling AgreementWorkTypeExclusionsApi.finance_agreements_id_work_type_exclusions_work_type_exclusion_id_delete" if work_type_exclusion_id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workTypeExclusions/{workTypeExclusionId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'workTypeExclusionId' + '}', work_type_exclusion_id.to_s)

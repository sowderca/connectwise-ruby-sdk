...
module Connectwise
  class AgreementWorkRolesApi
    ...
    def finance_agreements_id_workroles_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_count_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_workroles_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_get" if id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_workroles_post_with_http_info(id, work_role, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_post" if id.nil?
      # verify the required parameter 'work_role' is set
      fail ArgumentError, "Missing the required parameter 'work_role' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_post" if work_role.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def finance_agreements_id_workroles_work_role_id_delete_with_http_info(id, work_role_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_delete" if id.nil?
      # verify the required parameter 'work_role_id' is set
      fail ArgumentError, "Missing the required parameter 'work_role_id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_delete" if work_role_id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles/{workRoleId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'workRoleId' + '}', work_role_id.to_s)
    ...
    def finance_agreements_id_workroles_work_role_id_get_with_http_info(id, work_role_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_get" if id.nil?
      # verify the required parameter 'work_role_id' is set
      fail ArgumentError, "Missing the required parameter 'work_role_id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_get" if work_role_id.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles/{workRoleId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'workRoleId' + '}', work_role_id.to_s)
    ...
    def finance_agreements_id_workroles_work_role_id_patch_with_http_info(id, work_role_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_patch" if id.nil?
      # verify the required parameter 'work_role_id' is set
      fail ArgumentError, "Missing the required parameter 'work_role_id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_patch" if work_role_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_patch" if operations.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles/{workRoleId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'workRoleId' + '}', work_role_id.to_s)
    ...
    def finance_agreements_id_workroles_work_role_id_put_with_http_info(id, work_role_id, work_role, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_put" if id.nil?
      # verify the required parameter 'work_role_id' is set
      fail ArgumentError, "Missing the required parameter 'work_role_id' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_put" if work_role_id.nil?
      # verify the required parameter 'work_role' is set
      fail ArgumentError, "Missing the required parameter 'work_role' when calling AgreementWorkRolesApi.finance_agreements_id_workroles_work_role_id_put" if work_role.nil?
      # resource path
      local_var_path = "/finance/agreements/{id}/workroles/{workRoleId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'workRoleId' + '}', work_role_id.to_s)

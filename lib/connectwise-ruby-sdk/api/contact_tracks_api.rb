...
module Connectwise
  class ContactTracksApi
    ...
    def company_contacts_id_tracks_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactTracksApi.company_contacts_id_tracks_count_get" if id.nil?
      # resource path
      local_var_path = "/company/contacts/{id}/tracks/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_contacts_id_tracks_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactTracksApi.company_contacts_id_tracks_get" if id.nil?
      # resource path
      local_var_path = "/company/contacts/{id}/tracks".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_contacts_id_tracks_post_with_http_info(id, track, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactTracksApi.company_contacts_id_tracks_post" if id.nil?
      # verify the required parameter 'track' is set
      fail ArgumentError, "Missing the required parameter 'track' when calling ContactTracksApi.company_contacts_id_tracks_post" if track.nil?
      # resource path
      local_var_path = "/company/contacts/{id}/tracks".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_contacts_id_tracks_track_id_delete_with_http_info(id, track_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactTracksApi.company_contacts_id_tracks_track_id_delete" if id.nil?
      # verify the required parameter 'track_id' is set
      fail ArgumentError, "Missing the required parameter 'track_id' when calling ContactTracksApi.company_contacts_id_tracks_track_id_delete" if track_id.nil?
      # resource path
      local_var_path = "/company/contacts/{id}/tracks/{trackId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'trackId' + '}', track_id.to_s)
    ...
    def company_contacts_id_tracks_track_id_get_with_http_info(id, track_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactTracksApi.company_contacts_id_tracks_track_id_get" if id.nil?
      # verify the required parameter 'track_id' is set
      fail ArgumentError, "Missing the required parameter 'track_id' when calling ContactTracksApi.company_contacts_id_tracks_track_id_get" if track_id.nil?
      # resource path
      local_var_path = "/company/contacts/{id}/tracks/{trackId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'trackId' + '}', track_id.to_s)

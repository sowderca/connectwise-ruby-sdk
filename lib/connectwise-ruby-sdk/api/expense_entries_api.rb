...
module Connectwise
  class ExpenseEntriesApi
    ...
    def expense_entries_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/expense/entries/count".sub('{format}','json')
    ...
    def expense_entries_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/expense/entries".sub('{format}','json')
    ...
    def expense_entries_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ExpenseEntriesApi.expense_entries_id_delete" if id.nil?
      # resource path
      local_var_path = "/expense/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def expense_entries_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ExpenseEntriesApi.expense_entries_id_get" if id.nil?
      # resource path
      local_var_path = "/expense/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def expense_entries_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ExpenseEntriesApi.expense_entries_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ExpenseEntriesApi.expense_entries_id_patch" if operations.nil?
      # resource path
      local_var_path = "/expense/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def expense_entries_id_put_with_http_info(id, expense_entry, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ExpenseEntriesApi.expense_entries_id_put" if id.nil?
      # verify the required parameter 'expense_entry' is set
      fail ArgumentError, "Missing the required parameter 'expense_entry' when calling ExpenseEntriesApi.expense_entries_id_put" if expense_entry.nil?
      # resource path
      local_var_path = "/expense/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def expense_entries_post_with_http_info(expense_entry, opts = {})
      ...
      # verify the required parameter 'expense_entry' is set
      fail ArgumentError, "Missing the required parameter 'expense_entry' when calling ExpenseEntriesApi.expense_entries_post" if expense_entry.nil?
      # resource path
      local_var_path = "/expense/entries".sub('{format}','json')

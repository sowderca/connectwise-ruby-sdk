...
module ConnectWise
  class ProductTypesApi
    ...
    def procurement_types_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/types/count".sub('{format}','json')
    ...
    def procurement_types_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/types".sub('{format}','json')
    ...
    def procurement_types_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductTypesApi.procurement_types_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_types_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductTypesApi.procurement_types_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_types_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductTypesApi.procurement_types_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ProductTypesApi.procurement_types_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_types_id_put_with_http_info(id, product_types, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductTypesApi.procurement_types_id_put" if id.nil?
      # verify the required parameter 'product_types' is set
      fail ArgumentError, "Missing the required parameter 'product_types' when calling ProductTypesApi.procurement_types_id_put" if product_types.nil?
      # resource path
      local_var_path = "/procurement/types/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_types_post_with_http_info(product_types, opts = {})
      ...
      # verify the required parameter 'product_types' is set
      fail ArgumentError, "Missing the required parameter 'product_types' when calling ProductTypesApi.procurement_types_post" if product_types.nil?
      # resource path
      local_var_path = "/procurement/types".sub('{format}','json')

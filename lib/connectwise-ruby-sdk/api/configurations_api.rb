...
module ConnectWise
  class ConfigurationsApi
    ...
    def company_configurations_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/configurations/count".sub('{format}','json')
    ...
    def company_configurations_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/company/configurations".sub('{format}','json')
    ...
    def company_configurations_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ConfigurationsApi.company_configurations_id_delete" if id.nil?
      # resource path
      local_var_path = "/company/configurations/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_configurations_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ConfigurationsApi.company_configurations_id_get" if id.nil?
      # resource path
      local_var_path = "/company/configurations/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def company_configurations_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ConfigurationsApi.company_configurations_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ConfigurationsApi.company_configurations_id_patch" if operations.nil?
    ...
    def company_configurations_id_put_with_http_info(id, configuration, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ConfigurationsApi.company_configurations_id_put" if id.nil?
      # verify the required parameter 'configuration' is set
      fail ArgumentError, "Missing the required parameter 'configuration' when calling ConfigurationsApi.company_configurations_id_put" if configuration.nil?
      if opts[:'type'] && !['Ticket', 'Configuration'].include?(opts[:'type'])
        fail ArgumentError, 'invalid value for "type", must be one of Ticket, Configuration'
      end
      # resource path
    ...
    def company_configurations_post_with_http_info(configuration, opts = {})
      ...
      # verify the required parameter 'configuration' is set
      fail ArgumentError, "Missing the required parameter 'configuration' when calling ConfigurationsApi.company_configurations_post" if configuration.nil?
      if opts[:'type'] && !['Ticket', 'Configuration'].include?(opts[:'type'])
        fail ArgumentError, 'invalid value for "type", must be one of Ticket, Configuration'
      end
      # resource path

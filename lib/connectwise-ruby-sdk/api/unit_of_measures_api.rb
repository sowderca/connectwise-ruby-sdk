...
module ConnectWise
  class UnitOfMeasuresApi
    ...
    def procurement_unit_of_measures_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_delete" if id.nil?
      # resource path
    ...
    def procurement_unit_of_measures_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/unitOfMeasures/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_unit_of_measures_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/unitOfMeasures/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_unit_of_measures_id_put_with_http_info(id, unit_of_measure, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_put" if id.nil?
      # verify the required parameter 'unit_of_measure' is set
      fail ArgumentError, "Missing the required parameter 'unit_of_measure' when calling UnitOfMeasuresApi.procurement_unit_of_measures_id_put" if unit_of_measure.nil?
      # resource path
      local_var_path = "/procurement/unitOfMeasures/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_unit_of_measures_post_with_http_info(unit_of_measure, opts = {})
      ...
      # verify the required parameter 'unit_of_measure' is set
      fail ArgumentError, "Missing the required parameter 'unit_of_measure' when calling UnitOfMeasuresApi.procurement_unit_of_measures_post" if unit_of_measure.nil?
      # resource path
      local_var_path = "/procurement/unitOfMeasures".sub('{format}','json')

...
module Connectwise
  class ManufacturersApi
    ...
    def procurement_manufacturers_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/manufacturers/count".sub('{format}','json')
    ...
    def procurement_manufacturers_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/manufacturers".sub('{format}','json')
    ...
    def procurement_manufacturers_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ManufacturersApi.procurement_manufacturers_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/manufacturers/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_manufacturers_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ManufacturersApi.procurement_manufacturers_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/manufacturers/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_manufacturers_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ManufacturersApi.procurement_manufacturers_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ManufacturersApi.procurement_manufacturers_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/manufacturers/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_manufacturers_id_put_with_http_info(id, manufacturer, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ManufacturersApi.procurement_manufacturers_id_put" if id.nil?
      # verify the required parameter 'manufacturer' is set
      fail ArgumentError, "Missing the required parameter 'manufacturer' when calling ManufacturersApi.procurement_manufacturers_id_put" if manufacturer.nil?
      # resource path
      local_var_path = "/procurement/manufacturers/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_manufacturers_post_with_http_info(manufacturer, opts = {})
      ...
      # verify the required parameter 'manufacturer' is set
      fail ArgumentError, "Missing the required parameter 'manufacturer' when calling ManufacturersApi.procurement_manufacturers_post" if manufacturer.nil?
      # resource path
      local_var_path = "/procurement/manufacturers".sub('{format}','json')

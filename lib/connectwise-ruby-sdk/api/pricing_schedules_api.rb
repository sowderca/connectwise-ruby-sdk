...
module ConnectWise
  class PricingSchedulesApi
    ...
    def procurement_pricingschedules_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/pricingschedules/count".sub('{format}','json')
    ...
    def procurement_pricingschedules_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/pricingschedules".sub('{format}','json')
    ...
    def procurement_pricingschedules_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling PricingSchedulesApi.procurement_pricingschedules_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/pricingschedules/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_pricingschedules_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PricingSchedulesApi.procurement_pricingschedules_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/pricingschedules/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_pricingschedules_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PricingSchedulesApi.procurement_pricingschedules_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling PricingSchedulesApi.procurement_pricingschedules_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/pricingschedules/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_pricingschedules_id_put_with_http_info(id, pricing_schedule, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PricingSchedulesApi.procurement_pricingschedules_id_put" if id.nil?
      # verify the required parameter 'pricing_schedule' is set
      fail ArgumentError, "Missing the required parameter 'pricing_schedule' when calling PricingSchedulesApi.procurement_pricingschedules_id_put" if pricing_schedule.nil?
      # resource path
      local_var_path = "/procurement/pricingschedules/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_pricingschedules_post_with_http_info(pricing_schedule, opts = {})
      ...
      # verify the required parameter 'pricing_schedule' is set
      fail ArgumentError, "Missing the required parameter 'pricing_schedule' when calling PricingSchedulesApi.procurement_pricingschedules_post" if pricing_schedule.nil?
      # resource path
      local_var_path = "/procurement/pricingschedules".sub('{format}','json')

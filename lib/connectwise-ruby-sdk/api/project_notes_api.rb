...
module ConnectWise
  class ProjectNotesApi
    ...
    def project_projects_id_notes_count_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_count_get" if id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/notes/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_id_notes_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_get" if id.nil?
      # resource path
      local_var_path = "/project/projects/{id}/notes".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def project_projects_id_notes_note_id_delete_with_http_info(id, note_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_note_id_delete" if id.nil?
      # verify the required parameter 'note_id' is set
      fail ArgumentError, "Missing the required parameter 'note_id' when calling ProjectNotesApi.project_projects_id_notes_note_id_delete" if note_id.nil?
      # resource path
    ...
    def project_projects_id_notes_note_id_patch_with_http_info(id, note_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_note_id_patch" if id.nil?
      # verify the required parameter 'note_id' is set
      fail ArgumentError, "Missing the required parameter 'note_id' when calling ProjectNotesApi.project_projects_id_notes_note_id_patch" if note_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ProjectNotesApi.project_projects_id_notes_note_id_patch" if operations.nil?
      # resource path
      local_var_path = "/project/projects/{id}/notes/{noteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'noteId' + '}', note_id.to_s)
    ...
    def project_projects_id_notes_note_id_put_with_http_info(id, note_id, note, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_note_id_put" if id.nil?
      # verify the required parameter 'note_id' is set
      fail ArgumentError, "Missing the required parameter 'note_id' when calling ProjectNotesApi.project_projects_id_notes_note_id_put" if note_id.nil?
      # verify the required parameter 'note' is set
      fail ArgumentError, "Missing the required parameter 'note' when calling ProjectNotesApi.project_projects_id_notes_note_id_put" if note.nil?
      # resource path
      local_var_path = "/project/projects/{id}/notes/{noteId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'noteId' + '}', note_id.to_s)
    ...
    def project_projects_id_notes_post_with_http_info(id, note, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProjectNotesApi.project_projects_id_notes_post" if id.nil?
      # verify the required parameter 'note' is set
      fail ArgumentError, "Missing the required parameter 'note' when calling ProjectNotesApi.project_projects_id_notes_post" if note.nil?
      # resource path
      local_var_path = "/project/projects/{id}/notes".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

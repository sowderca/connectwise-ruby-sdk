...
module Connectwise
  class TimeEntriesApi
    ...
    def time_entries_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/time/entries/count".sub('{format}','json')
    ...
    def time_entries_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/time/entries".sub('{format}','json')
    ...
    def time_entries_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling TimeEntriesApi.time_entries_id_delete" if id.nil?
      # resource path
      local_var_path = "/time/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_entries_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TimeEntriesApi.time_entries_id_get" if id.nil?
      # resource path
      local_var_path = "/time/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_entries_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TimeEntriesApi.time_entries_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling TimeEntriesApi.time_entries_id_patch" if operations.nil?
      # resource path
      local_var_path = "/time/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_entries_id_put_with_http_info(id, time_entry, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling TimeEntriesApi.time_entries_id_put" if id.nil?
      # verify the required parameter 'time_entry' is set
      fail ArgumentError, "Missing the required parameter 'time_entry' when calling TimeEntriesApi.time_entries_id_put" if time_entry.nil?
      # resource path
      local_var_path = "/time/entries/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def time_entries_post_with_http_info(time_entry, opts = {})
      ...
      # verify the required parameter 'time_entry' is set
      fail ArgumentError, "Missing the required parameter 'time_entry' when calling TimeEntriesApi.time_entries_post" if time_entry.nil?
      # resource path
      local_var_path = "/time/entries".sub('{format}','json')

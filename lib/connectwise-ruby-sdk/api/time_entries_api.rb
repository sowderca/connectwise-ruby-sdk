...
module ConnectWise
  class TimeEntriesApi
    ...
    # @param time_entry 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TimeEntry, Fixnum, Hash)>] TimeEntry data, response status code and response headers
    ...
    # @option opts [Integer] :page 
    # @option opts [Integer] :page_size 
    # @return [Array<(Array<TimeEntry>, Fixnum, Hash)>] Array<TimeEntry> data, response status code and response headers

...
module ConnectWise
  class CatalogsItemApi
    ...
    def procurement_catalog_catalog_item_identifier_quantity_on_hand_get_with_http_info(catalog_item_identifier, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'catalog_item_identifier' when calling CatalogsItemApi.procurement_catalog_catalog_item_identifier_quantity_on_hand_get" if catalog_item_identifier.nil?
      # resource path
      local_var_path = "/procurement/catalog/{catalogItemIdentifier}/quantityOnHand".sub('{format}','json').sub('{' + 'catalogItemIdentifier' + '}', catalog_item_identifier.to_s)
    ...
    def procurement_catalog_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/catalog/count".sub('{format}','json')
    ...
    def procurement_catalog_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/procurement/catalog".sub('{format}','json')
    ...
    def procurement_catalog_id_delete_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.procurement_catalog_id_delete" if id.nil?
      # resource path
      local_var_path = "/procurement/catalog/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_catalog_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.procurement_catalog_id_get" if id.nil?
      # resource path
      local_var_path = "/procurement/catalog/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_catalog_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.procurement_catalog_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling CatalogsItemApi.procurement_catalog_id_patch" if operations.nil?
      # resource path
      local_var_path = "/procurement/catalog/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_catalog_id_put_with_http_info(id, catalog_item, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.procurement_catalog_id_put" if id.nil?
      # verify the required parameter 'catalog_item' is set
      fail ArgumentError, "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.procurement_catalog_id_put" if catalog_item.nil?
      # resource path
      local_var_path = "/procurement/catalog/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def procurement_catalog_post_with_http_info(catalog_item, opts = {})
      ...
      # verify the required parameter 'catalog_item' is set
      fail ArgumentError, "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.procurement_catalog_post" if catalog_item.nil?
      # resource path
      local_var_path = "/procurement/catalog".sub('{format}','json')

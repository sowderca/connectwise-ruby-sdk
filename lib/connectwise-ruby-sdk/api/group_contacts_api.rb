...
module Connectwise
  class GroupContactsApi
    ...
    def marketing_groups_id_contacts_contact_id_delete_with_http_info(id, contact_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_delete" if id.nil?
      # verify the required parameter 'contact_id' is set
      fail ArgumentError, "Missing the required parameter 'contact_id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_delete" if contact_id.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts/{contactId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'contactId' + '}', contact_id.to_s)
    ...
    def marketing_groups_id_contacts_contact_id_get_with_http_info(id, contact_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_get" if id.nil?
      # verify the required parameter 'contact_id' is set
      fail ArgumentError, "Missing the required parameter 'contact_id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_get" if contact_id.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts/{contactId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'contactId' + '}', contact_id.to_s)
    ...
    def marketing_groups_id_contacts_contact_id_patch_with_http_info(id, contact_id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_patch" if id.nil?
      # verify the required parameter 'contact_id' is set
      fail ArgumentError, "Missing the required parameter 'contact_id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_patch" if contact_id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_patch" if operations.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts/{contactId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'contactId' + '}', contact_id.to_s)
    ...
    def marketing_groups_id_contacts_contact_id_put_with_http_info(id, contact_id, marketing_contact, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_put" if id.nil?
      # verify the required parameter 'contact_id' is set
      fail ArgumentError, "Missing the required parameter 'contact_id' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_put" if contact_id.nil?
      # verify the required parameter 'marketing_contact' is set
      fail ArgumentError, "Missing the required parameter 'marketing_contact' when calling GroupContactsApi.marketing_groups_id_contacts_contact_id_put" if marketing_contact.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts/{contactId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'contactId' + '}', contact_id.to_s)
    ...
    def marketing_groups_id_contacts_count_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_count_get" if id.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts/count".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_groups_id_contacts_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_get" if id.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def marketing_groups_id_contacts_post_with_http_info(id, marketing_contact, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GroupContactsApi.marketing_groups_id_contacts_post" if id.nil?
      # verify the required parameter 'marketing_contact' is set
      fail ArgumentError, "Missing the required parameter 'marketing_contact' when calling GroupContactsApi.marketing_groups_id_contacts_post" if marketing_contact.nil?
      # resource path
      local_var_path = "/marketing/groups/{id}/contacts".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

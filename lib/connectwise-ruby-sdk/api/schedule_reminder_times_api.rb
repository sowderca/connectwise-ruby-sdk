...
module ConnectWise
  class ScheduleReminderTimesApi
    ...
    def schedule_reminder_times_count_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/schedule/reminderTimes/count".sub('{format}','json')
    ...
    def schedule_reminder_times_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/schedule/reminderTimes".sub('{format}','json')
    ...
    def schedule_reminder_times_id_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleReminderTimesApi.schedule_reminder_times_id_get" if id.nil?
      # resource path
      local_var_path = "/schedule/reminderTimes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def schedule_reminder_times_id_patch_with_http_info(id, operations, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleReminderTimesApi.schedule_reminder_times_id_patch" if id.nil?
      # verify the required parameter 'operations' is set
      fail ArgumentError, "Missing the required parameter 'operations' when calling ScheduleReminderTimesApi.schedule_reminder_times_id_patch" if operations.nil?
      # resource path
      local_var_path = "/schedule/reminderTimes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def schedule_reminder_times_id_put_with_http_info(id, reminder_time, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleReminderTimesApi.schedule_reminder_times_id_put" if id.nil?
      # verify the required parameter 'reminder_time' is set
      fail ArgumentError, "Missing the required parameter 'reminder_time' when calling ScheduleReminderTimesApi.schedule_reminder_times_id_put" if reminder_time.nil?
      # resource path
      local_var_path = "/schedule/reminderTimes/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)

...
module Connectwise
  ...
  class Type
    ...
    attr_accessor :request_for_change
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requestForChange')
        self.request_for_change = attributes[:'requestForChange']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inactive == o.inactive &&
          request_for_change == o.request_for_change &&
          board_id == o.board_id &&
    ...
    def hash
      [id, name, category, default_flag, inactive, request_for_change, board_id, location_id, business_unit_id, _info].hash
    end

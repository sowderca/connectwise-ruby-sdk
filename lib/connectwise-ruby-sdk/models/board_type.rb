...
module ConnectWise
  ...
  class BoardType
    ...
    attr_accessor :request_for_change_flag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requestForChangeFlag')
        self.request_for_change_flag = attributes[:'requestForChangeFlag']
      end
    ...
    def category=(category)
      validator = EnumAttributeValidator.new('String', ["Reactive", "Proactive"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          request_for_change_flag == o.request_for_change_flag &&
    ...
    def hash
      [id, name, category, default_flag, inactive_flag, request_for_change_flag, integration_xref, board, location, department, _info].hash
    end

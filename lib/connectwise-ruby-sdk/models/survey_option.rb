...
module ConnectWise
  ...
  class SurveyOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'visibleflag')
        self.visibleflag = attributes[:'visibleflag']
      end
    ...
    def hash
      [id, caption, points, visibleflag, _info].hash
    end

...
module ConnectWise
  ...
  class CreateAccountingBatchRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'processedRecordIds')
        if (value = attributes[:'processedRecordIds']).is_a?(Array)
          self.processed_record_ids = value
        end
      end

      if attributes.has_key?(:'summarizeExpenses')
        self.summarize_expenses = attributes[:'summarizeExpenses']
      end
    ...
    def hash
      [id, batch_identifier, gl_interface_identifier, export_invoices_flag, export_expenses_flag, export_products_flag, processed_record_ids, summarize_expenses].hash
    end

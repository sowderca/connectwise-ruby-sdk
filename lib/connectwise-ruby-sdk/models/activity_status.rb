...
module ConnectWise
  ...
  class ActivityStatus
    ...
    attr_accessor :spawn_followup_flag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'spawnFollowupFlag')
        self.spawn_followup_flag = attributes[:'spawnFollowupFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          spawn_followup_flag == o.spawn_followup_flag &&
    ...
    def hash
      [id, name, default_flag, inactive_flag, spawn_followup_flag, closed_flag, _info].hash
    end

...
module Connectwise
  ...
  class OpportunityToAgreementConversion
    ...
    def hash
      [agreement_id, name, type, start_date, end_date, no_ending_date_flag, bill_cycle_id, location_id, business_unit_id, include_all_notes_flag, include_all_documents_flag, include_all_products_flag, include_note_ids, include_document_ids, include_product_ids].hash
    end

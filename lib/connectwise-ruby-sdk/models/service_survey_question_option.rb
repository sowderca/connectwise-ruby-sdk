...
module ConnectWise
  ...
  class ServiceSurveyQuestionOption
    ...
    def list_invalid_properties
      ...
      if !@points.nil? && @points > 32767
        invalid_properties.push("invalid value for 'points', must be smaller than or equal to 32767.")
      end

      if !@points.nil? && @points < -32768
        invalid_properties.push("invalid value for 'points', must be greater than or equal to -32768.")
      end
    ...
    def valid?
      ...
      return false if !@points.nil? && @points > 32767
      return false if !@points.nil? && @points < -32768
      return true
    end
    ...
    def points=(points)
      ...
      if !points.nil? && points > 32767
        fail ArgumentError, "invalid value for 'points', must be smaller than or equal to 32767."
      end

      if !points.nil? && points < -32768
        fail ArgumentError, "invalid value for 'points', must be greater than or equal to -32768."
      end
    ...
    def hash
      [include_flag, caption, points].hash
    end

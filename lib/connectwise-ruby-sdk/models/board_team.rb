...
module ConnectWise
  ...
  class BoardTeam
    ...
    attr_accessor :notify_on_ticket_delete
    ...
    def self.swagger_types
      {
        :'id' => :'Integer',
        :'name' => :'String',
        :'team_leader' => :'MemberReference',
        :'members' => :'Array<Integer>',
        :'default_flag' => :'BOOLEAN',
        :'notify_on_ticket_delete' => :'BOOLEAN',
        :'board_id' => :'Integer',
        :'location_id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teamLeader')
        self.team_leader = attributes[:'teamLeader']
      end
      ...
      if attributes.has_key?(:'notifyOnTicketDelete')
        self.notify_on_ticket_delete = attributes[:'notifyOnTicketDelete']
      end
    ...
    def list_invalid_properties
      ...
      if @team_leader.nil?
        invalid_properties.push("invalid value for 'team_leader', team_leader cannot be nil.")
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notify_on_ticket_delete == o.notify_on_ticket_delete &&
          board_id == o.board_id &&
    ...
    def hash
      [id, name, team_leader, members, default_flag, notify_on_ticket_delete, board_id, location_id, business_unit_id, _info].hash
    end

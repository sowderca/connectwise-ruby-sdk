...
module ConnectWise
  ...
  class CatalogComponent
    ...
    def hash
      [id, sequence_number, quantity, catalog_item, hide_price_flag, hide_item_identifier_flag, hide_description_flag, hide_quantity_flag, parent_catalog_item, price, cost, _info].hash
    end

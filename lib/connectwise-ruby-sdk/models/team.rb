...
module ConnectWise
  ...
  class Team
    ...
    def hash
      [id, type, member, sales_team, commission_percent, referral_flag, opportunity_id, responsible_flag, _info, name, team_leader, members, default_flag, notify_on_ticket_delete, board_id, location_id, business_unit_id].hash
    end

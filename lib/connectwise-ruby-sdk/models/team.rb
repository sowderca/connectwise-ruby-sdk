...
module ConnectWise
  ...
  class Team
    ...
    attr_accessor :referral_flag

    attr_accessor :opportunity_id

    attr_accessor :responsible_flag
    ...
    def self.swagger_types
      {
        ...
        :'sales_team' => :'SalesTeamReference',
        :'commission_percent' => :'Integer',
        :'referral_flag' => :'BOOLEAN',
        :'opportunity_id' => :'Integer',
        :'responsible_flag' => :'BOOLEAN',
        :'_info' => :'Metadata'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'referralFlag')
        self.referral_flag = attributes[:'referralFlag']
      end
      ...
      if attributes.has_key?(:'responsibleFlag')
        self.responsible_flag = attributes[:'responsibleFlag']
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Individual", "Team"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          referral_flag == o.referral_flag &&
          opportunity_id == o.opportunity_id &&
          responsible_flag == o.responsible_flag &&
          _info == o._info
    end
    ...
    def hash
      [id, type, member, sales_team, commission_percent, referral_flag, opportunity_id, responsible_flag, _info].hash
    end

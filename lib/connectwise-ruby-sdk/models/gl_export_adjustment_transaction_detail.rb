...
module ConnectWise
  ...
  class GLExportAdjustmentTransactionDetail
    ...
    def hash
      [gl_class, description, memo, item, quantity, total, cost, cost_account_number, inventory_account_number, account_number, product_account_number].hash
    end

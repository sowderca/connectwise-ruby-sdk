...
module ConnectWise
  ...
  class ProductComponent
    ...
    attr_accessor :parent_product_item
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parentProductItem')
        self.parent_product_item = attributes[:'parentProductItem']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vendor == o.vendor &&
          parent_product_item == o.parent_product_item &&
    ...
    def hash
      [id, sequence_number, quantity, catalog_item, hide_price_flag, hide_item_identifier_flag, hide_description_flag, hide_quantity_flag, vendor, parent_product_item, product_item, price, cost, _info].hash
    end

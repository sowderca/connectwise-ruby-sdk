...
module ConnectWise
  ...
  class CustomFieldValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entryMethod')
        self.entry_method = attributes[:'entryMethod']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["Button", "Checkbox", "Currency", "Date", "Hyperlink", "IPAddress", "Number", "Password", "Percent", "Text", "TextArea"])
      return false unless type_validator.valid?(@type)
      entry_method_validator = EnumAttributeValidator.new('String', ["EntryField", "List", "Option"])
    ...
    def hash
      [id, caption, type, entry_method, number_of_decimals, value].hash
    end

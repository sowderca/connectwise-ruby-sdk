...
module ConnectWise
  ...
  class AdjustmentDetail
    ...
    attr_accessor :quantity_adjusted
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'quantityOnHand')
        self.quantity_on_hand = attributes[:'quantityOnHand']
      end
      ...
      if attributes.has_key?(:'quantityAdjusted')
        self.quantity_adjusted = attributes[:'quantityAdjusted']
      end
    ...
    def list_invalid_properties
      ...
      if @warehouse_bin.nil?
        invalid_properties.push("invalid value for 'warehouse_bin', warehouse_bin cannot be nil.")
      end

      if @quantity_adjusted.nil?
        invalid_properties.push("invalid value for 'quantity_adjusted', quantity_adjusted cannot be nil.")
      end

      if !@serial_number.nil? && @serial_number.to_s.length > 1000
        invalid_properties.push("invalid value for 'serial_number', the character length must be smaller than or equal to 1000.")
      end
    ...
    def valid?
      ...
      return false if @quantity_adjusted.nil?
      return false if !@serial_number.nil? && @serial_number.to_s.length > 1000
      return true
    end
    ...
    def serial_number=(serial_number)
      ...
      if !serial_number.nil? && serial_number.to_s.length > 1000
        fail ArgumentError, "invalid value for 'serial_number', the character length must be smaller than or equal to 1000."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          quantity_adjusted == o.quantity_adjusted &&
    ...
    def hash
      [id, catalog_item, description, quantity_on_hand, unit_cost, warehouse, warehouse_bin, quantity_adjusted, serial_number, adjustment, _info].hash
    end

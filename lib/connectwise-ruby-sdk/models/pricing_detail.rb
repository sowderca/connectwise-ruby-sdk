...
module ConnectWise
  ...
  class PricingDetail
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'noEndDate')
        self.no_end_date = attributes[:'noEndDate']
      end
    ...
    def hash
      [id, product, category, sub_category, start_date, end_date, no_end_date, _info].hash
    end

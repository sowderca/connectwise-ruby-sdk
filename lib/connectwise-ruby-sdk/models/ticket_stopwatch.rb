...
module ConnectWise
  ...
  class TicketStopwatch
    ...
    attr_accessor :ticket_mobile_guid
    ...
    attr_accessor :show_notes_in_discussion_flag

    attr_accessor :show_notes_in_internal_flag

    attr_accessor :show_notes_in_resolution_flag

    attr_accessor :email_notes_to_contact_flag

    attr_accessor :email_notes_to_resources_flag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ticketMobileGuid')
        self.ticket_mobile_guid = attributes[:'ticketMobileGuid']
      end
      ...
      if attributes.has_key?(:'showNotesInDiscussionFlag')
        self.show_notes_in_discussion_flag = attributes[:'showNotesInDiscussionFlag']
      end

      if attributes.has_key?(:'showNotesInInternalFlag')
        self.show_notes_in_internal_flag = attributes[:'showNotesInInternalFlag']
      end

      if attributes.has_key?(:'showNotesInResolutionFlag')
        self.show_notes_in_resolution_flag = attributes[:'showNotesInResolutionFlag']
      end

      if attributes.has_key?(:'emailNotesToContactFlag')
        self.email_notes_to_contact_flag = attributes[:'emailNotesToContactFlag']
      end

      if attributes.has_key?(:'emailNotesToResourcesFlag')
        self.email_notes_to_resources_flag = attributes[:'emailNotesToResourcesFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          ticket == o.ticket &&
          ticket_mobile_guid == o.ticket_mobile_guid &&
          total_pause_time == o.total_pause_time &&
          work_role == o.work_role &&
          work_type == o.work_type &&
          show_notes_in_discussion_flag == o.show_notes_in_discussion_flag &&
          show_notes_in_internal_flag == o.show_notes_in_internal_flag &&
          show_notes_in_resolution_flag == o.show_notes_in_resolution_flag &&
          email_notes_to_contact_flag == o.email_notes_to_contact_flag &&
          email_notes_to_resources_flag == o.email_notes_to_resources_flag
    end
    ...
    def hash
      [_info, agreement, billable_option, business_unit_id, date_entered, end_time, id, internal_notes, location_id, member, mobile_guid, notes, service_status, start_time, status, ticket, ticket_mobile_guid, total_pause_time, work_role, work_type, show_notes_in_discussion_flag, show_notes_in_internal_flag, show_notes_in_resolution_flag, email_notes_to_contact_flag, email_notes_to_resources_flag].hash
    end

...
module ConnectWise
  ...
  class LdapConfiguration
    ...
    def list_invalid_properties
      ...
      if @domain.to_s.length > 50
        invalid_properties.push("invalid value for 'domain', the character length must be smaller than or equal to 50.")
      end
    ...
    def valid?
      ...
      return false if @server.to_s.length > 200
      return false if @domain.nil?
      return false if @domain.to_s.length > 50
      return true
    end
    ...
    def domain=(domain)
      ...
      if domain.to_s.length > 50
        fail ArgumentError, "invalid value for 'domain', the character length must be smaller than or equal to 50."
      end
    ...
    def hash
      [id, name, server, domain, _info].hash
    end

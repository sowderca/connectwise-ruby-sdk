...
module ConnectWise
  ...
  class TimeEntry
    ...
    def hash
      [id, company, charge_to_id, charge_to_type, member, location_id, business_unit_id, work_type, work_role, agreement, time_start, time_end, hours_deduct, actual_hours, billable_option, notes, internal_notes, add_to_detail_description_flag, add_to_internal_analysis_flag, add_to_resolution_flag, email_resource_flag, email_contact_flag, email_cc_flag, email_cc, hours_billed, entered_by, date_entered, invoice, hourly_rate, _info, custom_fields].hash
    end

...
module ConnectWise
  ...
  class SLAPriority
    ...
    def list_invalid_properties
      ...
      if !@respond_hours.nil? && @respond_hours > 999.99
        invalid_properties.push("invalid value for 'respond_hours', must be smaller than or equal to 999.99.")
      end
      ...
      if !@plan_within.nil? && @plan_within > 999.99
        invalid_properties.push("invalid value for 'plan_within', must be smaller than or equal to 999.99.")
      end
      ...
      if !@resolution_hours.nil? && @resolution_hours > 999.99
        invalid_properties.push("invalid value for 'resolution_hours', must be smaller than or equal to 999.99.")
      end
    ...
    def valid?
      ...
      return false if !@respond_hours.nil? && @respond_hours > 999.99
      ...
      return false if !@plan_within.nil? && @plan_within > 999.99
      ...
      return false if !@resolution_hours.nil? && @resolution_hours > 999.99
    ...
    def respond_hours=(respond_hours)
      ...
      if !respond_hours.nil? && respond_hours > 999.99
        fail ArgumentError, "invalid value for 'respond_hours', must be smaller than or equal to 999.99."
      end
    ...
    def plan_within=(plan_within)
      ...
      if !plan_within.nil? && plan_within > 999.99
        fail ArgumentError, "invalid value for 'plan_within', must be smaller than or equal to 999.99."
      end
    ...
    def resolution_hours=(resolution_hours)
      ...
      if !resolution_hours.nil? && resolution_hours > 999.99
        fail ArgumentError, "invalid value for 'resolution_hours', must be smaller than or equal to 999.99."
      end
    ...
    def hash
      [id, priority, respond_hours, respond_percent, plan_within, plan_within_percent, resolution_hours, resolution_percent, sla, _info].hash
    end

...
module ConnectWise
  ...
  class Classification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'employeeFlag')
        self.employee_flag = attributes[:'employeeFlag']
      end
    ...
    def hash
      [id, name, multiplier, default_flag, company_flag, employee_flag, _info].hash
    end

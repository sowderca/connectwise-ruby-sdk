...
module ConnectWise
  ...
  class GLExportExpenseBillDetail
    attr_accessor :id
    ...
    attr_accessor :reimbursable

    attr_accessor :company_advance
    ...
    def self.swagger_types
      {
        ...
        :'expense_class' => :'ClassificationReference',
        :'currency' => :'CurrencyReference',
        :'total' => :'Float',
        :'billable' => :'BOOLEAN',
        :'reimbursable' => :'BOOLEAN',
        :'company_advance' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reimbursable')
        self.reimbursable = attributes[:'reimbursable']
      end

      if attributes.has_key?(:'companyAdvance')
        self.company_advance = attributes[:'companyAdvance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total == o.total &&
          billable == o.billable &&
          reimbursable == o.reimbursable &&
          company_advance == o.company_advance
    end
    ...
    def hash
      [id, document_date, gl_type_id, memo, company, account_number, expense_class, currency, total, billable, reimbursable, company_advance].hash
    end

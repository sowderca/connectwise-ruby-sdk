...
module ConnectWise
  ...
  class ActivityStopwatch
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activityMobileGuid')
        self.activity_mobile_guid = attributes[:'activityMobileGuid']
      end
    ...
    def hash
      [_info, activity_id, activity_mobile_guid, agreement, billable_option, business_unit_id, date_entered, end_time, id, internal_notes, location_id, member, mobile_guid, notes, start_time, status, total_pause_time, work_role, work_type].hash
    end

...
module ConnectWise
  ...
  class ManagementNetworkSecurity
    attr_accessor :id
    ...
    def list_invalid_properties
      ...
      if @site.to_s.length > 100
        invalid_properties.push("invalid value for 'site', the character length must be smaller than or equal to 100.")
      end
    ...
    def valid?
      ...
      return false if !@username.nil? && @username.to_s.length > 50
      return false if !@password.nil? && @password.to_s.length > 50
      return false if @site.nil?
      return false if @site.to_s.length > 100
      return true
    end
    ...
    def site=(site)
      if site.nil?
        fail ArgumentError, "site cannot be nil"
      end

      if site.to_s.length > 100
        fail ArgumentError, "invalid value for 'site', the character length must be smaller than or equal to 100."
      end
    ...
    def hash
      [id, name, username, password, site, _info].hash
    end

...
module Connectwise
  ...
  class ConnectWiseHostedSetup
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Tab", "Pod"])
    ...
    def hash
      [id, screen_id, description, origin, url, pod_height, type, disabled_flag, created_by, date_created, _info].hash
    end

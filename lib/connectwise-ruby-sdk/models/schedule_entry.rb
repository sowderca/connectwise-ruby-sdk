...
module Connectwise
  ...
  class ScheduleEntry
    ...
    def hash
      [id, object_id, name, member, where, date_start, date_end, reminder, status, type, span, done_flag, acknowledged_flag, owner_flag, allow_schedule_conflicts_flag, add_member_to_project_flag, project_role_id, close_date, hours, _info].hash
    end

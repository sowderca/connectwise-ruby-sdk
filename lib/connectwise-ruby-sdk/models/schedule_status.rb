...
module ConnectWise
  ...
  class ScheduleStatus
    ...
    attr_accessor :show_as_tentative_flag
    ...
    def self.attribute_map
      {
        ...
        :'show_as_tentative_flag' => :'showAsTentativeFlag',
        :'_info' => :'_info'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'show_as_tentative_flag' => :'BOOLEAN',
        :'_info' => :'Metadata'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'showAsTentativeFlag')
        self.show_as_tentative_flag = attributes[:'showAsTentativeFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          show_as_tentative_flag == o.show_as_tentative_flag &&
          _info == o._info
    end
    ...
    def hash
      [id, name, default_flag, show_as_tentative_flag, _info].hash
    end

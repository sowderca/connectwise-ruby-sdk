...
module ConnectWise
  ...
  class OpportunityStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'wonFlag')
        self.won_flag = attributes[:'wonFlag']
      end

      if attributes.has_key?(:'lostFlag')
        self.lost_flag = attributes[:'lostFlag']
      end
    ...
    def hash
      [id, name, won_flag, lost_flag, closed_flag, inactive_flag, default_flag, _info, entered_by, date_entered].hash
    end

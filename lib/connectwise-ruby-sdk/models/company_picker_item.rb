...
module ConnectWise
  ...
  class CompanyPickerItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'companySite')
        self.company_site = attributes[:'companySite']
      end
      ...
      if attributes.has_key?(:'vendorPickerFlag')
        self.vendor_picker_flag = attributes[:'vendorPickerFlag']
      end

...
module ConnectWise
  ...
  class OpportunityToSalesOrderConversion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'salesOrderId')
        self.sales_order_id = attributes[:'salesOrderId']
      end
    ...
    def hash
      [sales_order_id, name, include_all_notes_flag, include_all_documents_flag, include_all_products_flag, include_note_ids, include_document_ids, include_product_ids].hash
    end

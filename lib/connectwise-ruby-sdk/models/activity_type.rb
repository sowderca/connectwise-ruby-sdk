...
module ConnectWise
  ...
  class ActivityType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memoFlag')
        self.memo_flag = attributes[:'memoFlag']
      end
    ...
    def hash
      [id, name, points, default_flag, inactive_flag, email_flag, memo_flag, _info].hash
    end

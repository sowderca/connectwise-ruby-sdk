...
module Connectwise
  ...
  class ExpenseType
    ...
    def hash
      [id, name, amount_caption, reimbursement_rate, bill_expenses, invoice_markup_option, invoice_markup_amount, advanced_amount_flag, mileage_flag, quantity_flag, inactive_flag, max_amount, _info].hash
    end

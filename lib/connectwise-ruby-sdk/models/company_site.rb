...
module Connectwise
  ...
  class CompanySite
    ...
    def hash
      [id, name, address_line1, address_line2, city, state, zip, country, phone_number, fax_number, tax_code_id, expense_reimbursement, primary_address_flag, default_shipping_flag, default_billing_flag, default_mailing_flag, calendar, time_zone, company, _info].hash
    end

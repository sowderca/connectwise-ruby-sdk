...
module ConnectWise
  ...
  class TeamMember
    ...
    attr_accessor :team_leader_flag
    ...
    def self.attribute_map
      {
        ...
        :'team' => :'team',
        :'member' => :'member',
        :'team_leader_flag' => :'teamLeaderFlag',
        :'_info' => :'_info'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teamLeaderFlag')
        self.team_leader_flag = attributes[:'teamLeaderFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          team == o.team &&
          member == o.member &&
          team_leader_flag == o.team_leader_flag &&
          _info == o._info
    end
    ...
    def hash
      [id, board, team, member, team_leader_flag, _info].hash
    end

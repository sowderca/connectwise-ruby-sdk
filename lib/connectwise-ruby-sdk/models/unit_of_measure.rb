...
module ConnectWise
  ...
  class UnitOfMeasure
    ...
    def list_invalid_properties
      ...
      if !@uom_schedule_xref.nil? && @uom_schedule_xref.to_s.length > 31
        invalid_properties.push("invalid value for 'uom_schedule_xref', the character length must be smaller than or equal to 31.")
      end
    ...
    def valid?
      ...
      return false if !@uom_schedule_xref.nil? && @uom_schedule_xref.to_s.length > 31
      return true
    end
    ...
    def uom_schedule_xref=(uom_schedule_xref)
      ...
      if !uom_schedule_xref.nil? && uom_schedule_xref.to_s.length > 31
        fail ArgumentError, "invalid value for 'uom_schedule_xref', the character length must be smaller than or equal to 31."
      end
    ...
    def hash
      [id, name, inactive_flag, default_flag, uom_schedule_xref, _info].hash
    end

...
module ConnectWise
  ...
  class Link
    ...
    def list_invalid_properties
      ...
      if @table_reference_id.nil?
        invalid_properties.push("invalid value for 'table_reference_id', table_reference_id cannot be nil.")
      end
    ...
    def hash
      [id, name, table_reference_id, url, _info].hash
    end

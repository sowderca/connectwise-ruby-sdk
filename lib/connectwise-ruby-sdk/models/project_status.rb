...
module ConnectWise
  ...
  class ProjectStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'noTimeFlag')
        self.no_time_flag = attributes[:'noTimeFlag']
      end
    ...
    def hash
      [id, name, default_flag, inactive_flag, no_time_flag, closed_flag, _info].hash
    end

...
module ConnectWise
  ...
  class PurchaseOrderStatusNotification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'workflowStep')
        self.workflow_step = attributes[:'workflowStep']
      end
    ...
    def list_invalid_properties
      ...
      if !@email.nil? && @email.to_s.length > 50
    ...
    def valid?
      ...
      return false if !@email.nil? && @email.to_s.length > 50
      return true
    end
    ...
    def hash
      [id, notify_who, status, member, email, workflow_step, _info].hash
    end

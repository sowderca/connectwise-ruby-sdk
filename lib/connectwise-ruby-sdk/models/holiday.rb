...
module ConnectWise
  ...
  class Holiday
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allDayFlag')
        self.all_day_flag = attributes[:'allDayFlag']
      end
    ...
    def hash
      [id, name, all_day_flag, date_start, date_end, holiday_list, _info].hash
    end

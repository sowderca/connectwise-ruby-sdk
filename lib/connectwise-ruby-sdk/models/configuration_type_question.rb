...
module Connectwise
  ...
  class ConfigurationTypeQuestion
    ...
    attr_accessor :configuration_type_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'configurationTypeId')
        self.configuration_type_id = attributes[:'configurationTypeId']
      end
      ...
      if attributes.has_key?(:'possibleAnswers')
        if (value = attributes[:'possibleAnswers']).is_a?(Array)
    ...
    def valid?
      ...
      field_type_validator = EnumAttributeValidator.new('String', ["Text", "Button", "Currency", "Date", "Hyperlink", "IPAddress", "Checkbox", "Number", "Percent", "TextArea", "Password"])
    ...
    def field_type=(field_type)
      validator = EnumAttributeValidator.new('String', ["Text", "Button", "Currency", "Date", "Hyperlink", "IPAddress", "Checkbox", "Number", "Percent", "TextArea", "Password"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          configuration_type_id == o.configuration_type_id &&
    ...
    def hash
      [id, configuration_type_id, field_type, entry_type, sequence_number, question, number_of_decimals, required_flag, inactive_flag, possible_answers, _info].hash
    end

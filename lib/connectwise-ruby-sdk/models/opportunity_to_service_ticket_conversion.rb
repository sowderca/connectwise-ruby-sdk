...
module ConnectWise
  ...
  class OpportunityToServiceTicketConversion
    ...
    def hash
      [ticket_id, summary, include_all_notes_flag, include_all_documents_flag, include_all_products_flag, include_note_ids, include_document_ids, include_product_ids].hash
    end

...
module ConnectWise
  ...
  class GLExportAdjustmentTransaction
    attr_accessor :id
    ...
    attr_accessor :adjustment_detail
    ...
    def self.swagger_types
      {
        ...
        :'adjustment_detail' => :'Array<GLExportAdjustmentTransactionDetail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adjustmentDescription')
        self.adjustment_description = attributes[:'adjustmentDescription']
      end

      if attributes.has_key?(:'adjustmentDetail')
        if (value = attributes[:'adjustmentDetail']).is_a?(Array)
          self.adjustment_detail = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          adjustment_detail == o.adjustment_detail
    end
    ...
    def hash
      [id, document_type, document_date, gl_type_id, account_number, memo, gl_class, adjustment_description, adjustment_detail].hash
    end

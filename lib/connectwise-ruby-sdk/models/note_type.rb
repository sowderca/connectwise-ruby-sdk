...
module ConnectWise
  ...
  class NoteType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'importFlag')
        self.import_flag = attributes[:'importFlag']
      end
    ...
    def list_invalid_properties
      ...
      if !@identifier.nil? && @identifier.to_s.length > 15
    ...
    def valid?
      return false if !@identifier.nil? && @identifier.to_s.length > 15
    ...
    def hash
      [id, identifier, name, default_flag, import_flag, _info].hash
    end

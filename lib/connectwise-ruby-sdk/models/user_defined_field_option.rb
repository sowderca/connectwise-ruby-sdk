...
module ConnectWise
  ...
  class UserDefinedFieldOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'optionValue')
        self.option_value = attributes[:'optionValue']
      end
    ...
    # @param [Object] option_value Value to be assigned
    def option_value=(option_value)
      if option_value.nil?
    ...
    def hash
      [id, option_value, default_flag, inactive_flag, sort_order].hash
    end

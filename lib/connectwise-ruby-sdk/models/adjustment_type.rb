...
module ConnectWise
  ...
  class AdjustmentType
    ...
    attr_accessor :audit_trail_flag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auditTrailFlag')
        self.audit_trail_flag = attributes[:'auditTrailFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          audit_trail_flag == o.audit_trail_flag &&
    ...
    def hash
      [id, identifier, name, audit_trail_flag, date_created, created_by, _info].hash
    end

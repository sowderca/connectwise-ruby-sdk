...
module ConnectWise
  ...
  class MemberAccrual
    ...
    def list_invalid_properties
      ...
      if @year > 50
        invalid_properties.push("invalid value for 'year', must be smaller than or equal to 50.")
      end

      if @year < 1
        invalid_properties.push("invalid value for 'year', must be greater than or equal to 1.")
      end
    ...
    def year=(year)
      ...
      if year > 50
        fail ArgumentError, "invalid value for 'year', must be smaller than or equal to 50."
      end

      if year < 1
        fail ArgumentError, "invalid value for 'year', must be greater than or equal to 1."
      end
    ...
    def hash
      [id, accrual_type, year, hours, reason, member, _info].hash
    end

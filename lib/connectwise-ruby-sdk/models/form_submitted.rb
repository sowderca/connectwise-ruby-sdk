...
module ConnectWise
  ...
  class FormSubmitted
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dateSubmitted')
        self.date_submitted = attributes[:'dateSubmitted']
      end
      ...
      if attributes.has_key?(:'pageSubType')
        self.page_sub_type = attributes[:'pageSubType']
      end
    ...
    def hash
      [id, campaign_id, contact_id, date_submitted, url, query_string, page_type, page_sub_type, topic, version, status].hash
    end

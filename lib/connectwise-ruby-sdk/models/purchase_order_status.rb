...
module ConnectWise
  ...
  class PurchaseOrderStatus
    ...
    attr_accessor :default_closed_flag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultClosedFlag')
        self.default_closed_flag = attributes[:'defaultClosedFlag']
      end
    ...
    def list_invalid_properties
      ...
      if !@sort_order.nil? && @sort_order > 9999
        invalid_properties.push("invalid value for 'sort_order', must be smaller than or equal to 9999.")
      end
    ...
    def valid?
      ...
      return false if !@sort_order.nil? && @sort_order > 9999
    ...
    def sort_order=(sort_order)
      ...
      if !sort_order.nil? && sort_order > 9999
        fail ArgumentError, "invalid value for 'sort_order', must be smaller than or equal to 9999."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_closed_flag == o.default_closed_flag &&
    ...
    def hash
      [id, name, default_flag, closed_flag, inactive_flag, default_closed_flag, sort_order, email_template, _info].hash
    end

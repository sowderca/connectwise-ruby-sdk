...
module ConnectWise
  ...
  class ProjectTeammember
    ...
    def self.swagger_types
      {
        ...
        :'project_role' => :'ProjectRoleReference',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'projectRole')
        self.project_role = attributes[:'projectRole']
      end
    ...
    def list_invalid_properties
      ...
      if @project_role.nil?
        invalid_properties.push("invalid value for 'project_role', project_role cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @project_role.nil?
      return true
    end
    ...
    def hash
      [id, project_id, hours, member, project_role, work_role, start_date, end_date, _info].hash
    end

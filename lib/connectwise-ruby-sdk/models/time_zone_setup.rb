...
module ConnectWise
  ...
  class TimeZoneSetup
    ...
    attr_accessor :daylight_savings_flag
    ...
    def self.attribute_map
      {
        ...
        :'daylight_savings_flag' => :'daylightSavingsFlag',
        :'_info' => :'_info'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'daylightSavingsFlag')
        self.daylight_savings_flag = attributes[:'daylightSavingsFlag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          daylight_savings_flag == o.daylight_savings_flag &&
          _info == o._info
    end
    ...
    def hash
      [id, name, time_zone, offset, default_flag, daylight_savings_flag, _info].hash
    end

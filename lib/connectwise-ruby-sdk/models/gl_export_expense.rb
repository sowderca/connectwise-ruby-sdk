...
module ConnectWise
  ...
  class GLExportExpense
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'apClass')
        self.ap_class = attributes[:'apClass']
      end
      ...
      if attributes.has_key?(:'periodStartDate')
        self.period_start_date = attributes[:'periodStartDate']
      end

      if attributes.has_key?(:'periodEndDate')
        self.period_end_date = attributes[:'periodEndDate']
      end

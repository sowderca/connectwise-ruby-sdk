...
module Connectwise
  ...
  class CampaignAudit
    ...
    def emails_sent=(emails_sent)
      ...
      if emails_sent > 2.147483647E9
        fail ArgumentError, "invalid value for 'emails_sent', must be smaller than or equal to 2.147483647E9."
      end

      if emails_sent < 0.0
        fail ArgumentError, "invalid value for 'emails_sent', must be greater than or equal to 0.0."
      end

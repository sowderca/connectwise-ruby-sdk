  ...
  class KnowledgeBaseArticle
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subCategoryId')
        self.sub_category_id = attributes[:'subCategoryId']
      end
    ...
    def list_invalid_properties
      ...
      if @issue.nil?
        invalid_properties.push("invalid value for 'issue', issue cannot be nil.")
      end
    ...
    def hash
      [id, title, issue, resolution, location_id, business_unit_id, board, category_id, sub_category_id, date_created, created_by, _info].hash
    end

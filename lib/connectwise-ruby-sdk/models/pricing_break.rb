...
module ConnectWise
  ...
  class PricingBreak
    ...
    attr_accessor :quantity_start

    attr_accessor :quantity_end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'detailId')
        self.detail_id = attributes[:'detailId']
      end
      ...
      if attributes.has_key?(:'quantityStart')
        self.quantity_start = attributes[:'quantityStart']
      end

      if attributes.has_key?(:'quantityEnd')
        self.quantity_end = attributes[:'quantityEnd']
      end

      if attributes.has_key?(:'unlimited')
        self.unlimited = attributes[:'unlimited']
      end
    ...
    def list_invalid_properties
      ...
      if @quantity_start.nil?
        invalid_properties.push("invalid value for 'quantity_start', quantity_start cannot be nil.")
      end

      if @price_method.nil?
        invalid_properties.push("invalid value for 'price_method', price_method cannot be nil.")
      end
    ...
    def valid?
      return false if @quantity_start.nil?
      return false if @price_method.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          quantity_start == o.quantity_start &&
          quantity_end == o.quantity_end &&
    ...
    def hash
      [id, detail_id, amount, quantity_start, quantity_end, unlimited, price_method, _info].hash
    end

...
describe 'CampaignSubTypesApi' do
  ...
  describe 'test an instance of CampaignSubTypesApi' do
    it 'should create an instact of CampaignSubTypesApi' do
  ...
  # unit tests for marketing_campaigns_types_id_sub_types_post
  # 
  ...
  describe 'marketing_campaigns_types_id_sub_types_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for marketing_campaigns_types_id_sub_types_sub_type_id_delete
  # 
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'marketing_campaigns_types_id_sub_types_sub_type_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for marketing_campaigns_types_id_sub_types_sub_type_id_patch
  # 
  ...
  # @param [Hash] opts the optional parameters
  # @return [CampaignSubType]
  describe 'marketing_campaigns_types_id_sub_types_sub_type_id_patch test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for marketing_campaigns_types_id_sub_types_sub_type_id_put
  # 
  ...
  # @param [Hash] opts the optional parameters
  # @return [CampaignSubType]
  describe 'marketing_campaigns_types_id_sub_types_sub_type_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
